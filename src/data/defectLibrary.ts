  ...
  locations: [
    ...
    },
    {
      ...
      defects: [
        ...
        { code: 'TTHHD', name: '透明纸划痕', category: 'D', standard: '划伤痕迹符合D区规定' },
        { code: 'TTZJC', name: '透明纸折角', category: 'C', standard: '透明纸折角长度≥10mm的个数≥2个' },
        { code: 'TTZJD', name: '透明纸折角', category: 'D', standard: '折角长度及数目符合D区规定' },
  ...
  locations: [
    ...
    },
    {
      ...
      defects: [
        ...
        { code: 'HTZZC', name: '透明纸皱', category: 'C', standard: '非热封面皱褶符合C区规定（附录C.2）' },
        { code: 'HTZZD', name: '透明纸皱', category: 'D', standard: '非热封面皱褶符合D区规定（附录C.2）' },
        ...
        { code: 'HTHHD', name: '透明纸划痕', category: 'D', standard: '划伤痕迹符合D区规定' },
        ...
        { code: 'HTZJD', name: '透明纸折角', category: 'D', standard: '符合D区规定' },
  ...
  locations: [
    ...
    },
    {
      ...
      defects: [
        ...
        { code: 'JASFB', name: '含水率', category: 'B', standard: '≤10.5%或≥13.5%', scoreCategory: 'misc' },
        { code: 'JASFC', name: '含水率', category: 'C', standard: '≤10.5%或≥13.5%', scoreCategory: 'misc' },
        { code: 'JAHMB', name: '含末率', category: 'B', standard: '超上限且超限值＞上限值的50%', scoreCategory: 'misc' },
        { code: 'JADLC', name: '端部落丝量', category: 'C', standard: '检测值≥15mg', scoreCategory: 'misc' },
        { code: 'JADLD', name: '端部落丝量', category: 'D', standard: '检测值≥15mg', scoreCategory: 'misc' },
        { code: 'JAXHA', name: '熄火', category: 'A', standard: '连续阴燃长度＜40mm', scoreCategory: 'misc' },
        { code: 'JAYRA', name: '引燃强度', category: 'A', standard: '熄火测试通过率≤75%', scoreCategory: 'misc' },
        { code: 'JAYSB', name: '压实端位置', category: 'B', standard: '绝对值＞8mm', scoreCategory: 'appearance' },
        { code: 'JAYSC', name: '压实端位置', category: 'C', standard: '绝对值＞8mm', scoreCategory: 'appearance' },
        { code: 'JAYSD', name: '压实端位置', category: 'D', standard: '绝对值＞8mm', scoreCategory: 'appearance' },
      ]
    }
  ]
};
